...
public class PenyiramanBerdasarkanCuaca {
    public static void main(String[] args) {
        ...
        System.out.println("\r" + " " + day[date.get(Calendar.DAY_OF_WEEK)] + " | " + date.get(Calendar.DAY_OF_MONTH) + " - " + month[date.get(Calendar.MONTH)] + " - " + date.get(Calendar.YEAR) + " " + date.get(Calendar.HOUR) + " : " + date.get(Calendar.MINUTE));
